            ...
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                    ...
                    <ul
                        ...
                        <li><a href="login_back.jsp"> <i class="icon-off"></i> 退出
                        </a></li>
                    </ul></li>
            </ul>
            <!-- /.ace-nav -->
    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="active"><a
                        href="back/bootm.do" target="mainframe">
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="goods/loadadd.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 商品添加
                        </a></li>
                        <li><a href="goods/list.do" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 商品查询
                        </a></li>
                        <li><a href="order/list.do" target="mainframe"> <i
        ...
        <div class="main-content" id="mains">
            <iframe id="mainframe" name="mainframe" src="back/bootm.do"
